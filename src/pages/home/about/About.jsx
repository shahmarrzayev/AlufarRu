          ...
          <div className="col-lg-7">
            <div className="aboutContent">
              ...
              <div className="texts">
               ...
               ALUFAR – динамично развивающаяся компания, обладающая производственным и интеллектуальным потенциалом. Производство компании оснащено современным оборудованием, специализируется на экструзии алюминиевых профилей, которые сочетают в себе инновации, качество и стиль.  </p>
                <p>
                Наши преимущества </p>
                <p>
